...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public static final int MY_SMOOTH_SCROLL_DURATION = 5;
    public static final int DEFAULT_SMOOTH_SCROLL_DURATION = 200;
    public static int SMOOTH_SCROLL_DURATION_MS = 1;
    ...
    public static enum AnimationStyle {
        ...
        static AnimationStyle mapIntToValue(int modeInt) {
            switch (modeInt) {
                case 0x0:
                default:
                    SMOOTH_SCROLL_DURATION_MS = DEFAULT_SMOOTH_SCROLL_DURATION;
                    return ROTATE;
                case 0x1:
                    SMOOTH_SCROLL_DURATION_MS = DEFAULT_SMOOTH_SCROLL_DURATION;
                    return FLIP;
                case 0x2:
                    SMOOTH_SCROLL_DURATION_MS = MY_SMOOTH_SCROLL_DURATION;
                    return MYROTATE;
            }
        }
