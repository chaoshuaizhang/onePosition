...
public class AdverView extends LinearLayout {
    ...
    private final float jdAdverHeight = 30;
    //显示的view
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int gap = array.getInteger(R.styleable.AdverView_gap, mGap);
        int animDuration = array.getInteger(R.styleable.AdverView_animDuration, mAnimDuration);
